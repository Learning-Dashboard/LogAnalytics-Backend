...
class InternalMetricRepositoryTest {
    ...
    void existsByParamName() {
        ...
        InternalMetric im2 = new InternalMetric("im2", "im2Name", "p2", null, "c2", "c2", true);
        entityManager.persistAndFlush(im2);
        assertFalse(internalMetricRepository.existsByParamName("paramName"));
        InternalMetric im3 = new InternalMetric("im3", "im3Name", "p3", "p3", "c3", "c3", true);
        entityManager.persistAndFlush(im3);
        assertFalse(internalMetricRepository.existsByParamName("paramName"));
        InternalMetric im4 = new InternalMetric("im4", "im4Name", "p4", "paramName", "c4", "c4", true);
