...
class EvaluationControllerTest {
    ...
    @Test
    void getEntityName() {
        UserlessInternalMetric uim = new UserlessInternalMetric("im", "imName", "param", "paramName", "controller", "controllerName", true, null, "userlessId", "userlessName");
        assertEquals("userlessName", evaluationController.getEntityName(uim));
        InternalMetric im = new InternalMetric("im", "imName", "param", "paramName", "controller", "controllerName", true, null);
    ...
    void groupMetrics() {
        ...
        UserlessInternalMetric im3 = new UserlessInternalMetric("im3", "name3", "p3", "pName3", "c3", "cName3", true, null, null, "id", "name");
        UserlessInternalMetric im4 = new UserlessInternalMetric("im4", "name4", "p4", "pName4", "c3", "cName3", true, null, null, "id", "name");
